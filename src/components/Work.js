...
const works = [
  ...
  },
  {
    ...
    workHeading: "Wilson",
    workDesc:
      "Wilson — Helping a century-old sports brand find its place in culture and step into an all-new category.",
  },
  {
    workImg: mountainImg,
    workHeading: "paragonia",
    workDesc:
      "store.google.com — A long-term relationship committed to bringing the best of Google to people worldwide.",
  },
];
        ...
        {works.map((item, index) => (
          <div className="worksImageContainer">
            ...
            <div className="workContent">
              <h1 className="mediumPara">{item.workHeading}</h1>
              <p className="smallPara">{item.workDesc}</p>
            </div>
          </div>
        ))}
      </div>
